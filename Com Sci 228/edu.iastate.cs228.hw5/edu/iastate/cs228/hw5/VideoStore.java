...
public class VideoStore 
{
   ...
   /**
	...
	public void addVideo(String film, int n)  
	{
		...
		boolean beenAdded = inventory.add(vid);
    ...
    {	
		...
		while (s.hasNext()) {
			...
			Video video = new Video(parseFilmName(line), parseNumCopies(line));
									     			 ...
									     			 AllCopiesRentedOutException 
	{
		if (n <= 0 || film == null)
			...
			else if (vid.getNumAvailableCopies() <= 0)
	...
	public String inventoryList()
	{
		...
		if (iter.hasNext())
			...
			str += "Films in inventory\n\n";
		
		while (iter.hasNext()) {
			
			Video vid = iter.next();
			
			str += vid.getFilm() + " (" + vid.getNumCopies() + ")\n";
		}
	...
	private String rentedVideosList()
	{
		...
		while (iter.hasNext()) {
			...
			if (vid.getNumRentedCopies() > 0)
				...
				str += vid.getFilm() + " (" + vid.getNumRentedCopies() + ")\n";
	...
	private String unrentedVideosList()
	{
		...
		if (iter.hasNext()) {
			...
			if (vid.getNumAvailableCopies() > 0)
				...
				str += "Films remaining in inventory:\n\n";
		}
		...
		while (iter.hasNext()) {
			...
			if (vid.getNumAvailableCopies() > 0)
				...
				str += vid.getFilm() + " (" + vid.getNumAvailableCopies() + ")\n";
